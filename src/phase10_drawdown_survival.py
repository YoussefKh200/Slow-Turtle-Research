...
OUT = os.path.join(os.path.dirname(__file__), "..", "results", "phase10")
...
if __name__ == "__main__":
    ...
    fig.savefig(os.path.join(CHARTS, "mae_mfe.png"), dpi=150)
    plt.close(fig)
    ...
    with open(os.path.join(OUT, "PHASE10_REPORT.md"), "w", encoding="utf-8") as f:
        f.write("\n".join(lines) + "\n")
    print("\n".join(lines[2:12]))
    print("Report -> results/phase10/PHASE10_REPORT.md")
