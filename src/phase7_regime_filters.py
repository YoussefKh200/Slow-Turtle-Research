...
from backtest import ma, atr, state_backtest
from stats import perf
OUT = os.path.join(os.path.dirname(__file__), "..", "results", "phase7")
...
if __name__ == "__main__":
    ...
    with open(os.path.join(OUT, "PHASE7_REPORT.md"), "w", encoding="utf-8") as f:
        f.write("\n".join(lines) + "\n")
    print(df.round(2).to_string())
    print("Report -> results/phase7/PHASE7_REPORT.md")
