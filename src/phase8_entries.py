...
OUT = os.path.join(os.path.dirname(__file__), "..", "results", "phase8")
...
if __name__ == "__main__":
    ...
    with open(os.path.join(OUT, "PHASE8_REPORT.md"), "w", encoding="utf-8") as f:
        f.write("\n".join(lines) + "\n")
    print(df.round(2).to_string())
    print("Report -> results/phase8/PHASE8_REPORT.md")
