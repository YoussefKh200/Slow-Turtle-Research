...
OUT = os.path.join(os.path.dirname(__file__), "..", "results", "phase4")
...
if __name__ == "__main__":
    ...
    df.round(2).to_csv(os.path.join(OUT, "sharpe_by_asset.csv"))
    lines = [
    ...
    with open(os.path.join(OUT, "PHASE4_REPORT.md"), "w", encoding="utf-8") as f:
        f.write("\n".join(lines) + "\n")
    print(summary.round(2).to_string())
    print("Report -> results/phase4/PHASE4_REPORT.md")
