...
OUT = os.path.join(os.path.dirname(__file__), "..", "results", "phase13")
...
if __name__ == "__main__":
    ...
    with open(os.path.join(OUT, "PHASE13_REPORT.md"), "w", encoding="utf-8") as f:
        f.write("\n".join(lines) + "\n")
    print(f"TF/MR correlation: {corr:.2f}")
    print(df.round(2).to_string())
    print("Report -> results/phase13/PHASE13_REPORT.md")
