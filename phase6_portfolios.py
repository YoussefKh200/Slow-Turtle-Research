...
from common import load_universe, perf
...
if __name__ == "__main__":
    ...
    fig.savefig(os.path.join(RESULTS_DIR, "phase6_equity.png"), dpi=150)
    plt.close(fig)
    ...
    with open(os.path.join(RESULTS_DIR, "phase6_report.md"), "w", encoding="utf-8") as f:
        f.write("\n".join(lines) + "\n")
    print(stats.round(2).to_string())
    print("\nAvg pairwise corr, all 16 sleeves:", round(corr.values[np.triu_indices(16, 1)].mean(), 2))
    print("Report -> results/phase6_report.md")
