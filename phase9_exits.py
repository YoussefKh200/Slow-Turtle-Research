...
import numpy as np
import pandas as pd
from common import load_universe, ma, atr, perf
...
if __name__ == "__main__":
    ...
    with open(os.path.join(RESULTS_DIR, "phase9_report.md"), "w", encoding="utf-8") as f:
        f.write("\n".join(lines) + "\n")
    print(df.round(2).to_string())
    print("Report -> results/phase9_report.md")
