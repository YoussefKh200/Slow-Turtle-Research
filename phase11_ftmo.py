...
from common import load_universe, perf, WEEKS_PER_YEAR
...
if __name__ == "__main__":
    ...
    fig.savefig(os.path.join(RESULTS_DIR, "phase11_equity.png"), dpi=150)
    plt.close(fig)
    ...
    with open(os.path.join(RESULTS_DIR, "phase11_report.md"), "w", encoding="utf-8") as f:
        f.write("\n".join(lines) + "\n")
    print(df.round(3).to_string())
    print("Report -> results/phase11_report.md")
